...
namespace MapImageExtractor
{
    public class MapReader
    {
        ...
        private void LoadMapType0()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 0: {ex.Message}");
            }
        ...
        private void LoadMapType1()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 1: {ex.Message}");
            }
        }
        ...
        private void LoadMapType2()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 2: {ex.Message}");
            }
        ...
        private void LoadMapType3()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 3: {ex.Message}");
            }
        }
        ...
        private void LoadMapType4()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 4: {ex.Message}");
            }
        }
        ...
        private void LoadMapType5()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 5: {ex.Message}");
            }
        }
        ...
        private void LoadMapType6()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 6: {ex.Message}");
            }
        ...
        private void LoadMapType7()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 7: {ex.Message}");
            }
        }
        ...
        private void LoadMapType100()
        {
            ...
            {
                Console.WriteLine($"Error loading map type 100: {ex.Message}");
            }
        }
