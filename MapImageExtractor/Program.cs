...
namespace MapImageExtractor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Run(mapName, outputDirectory, resDirectory, verbose);
        }
        ...
        static void Run(string mapName, string outputDirectory, string resDirectory, bool verbose)
        {
            try
            {
                string mapDirectory = Path.Combine(resDirectory, "Map");
                string dataDirectory = Path.Combine(resDirectory, "Data");
                ...
                ClientMapRenderer.RenderFullMap(mapReader, outputDirectory, verbose);
            }
            catch (Exception ex)
            {
